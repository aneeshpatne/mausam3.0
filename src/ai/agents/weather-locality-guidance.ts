export const MUMBAI_LOCALITY_GUIDANCE = [
  ...
  "If the imagery only supports an approximate zone, name 1-3 representative localities and mark them as approximate or best-effort rather than using only broad directional wording.",
  "Do not invent exact neighborhood impacts, flooding, rainfall totals, or station values for a locality unless station/sensor data supports it.",
  "Never transfer severity from another locality to Borivali without evidence that the weather affects or is likely to affect Borivali within six hours.",
  "Broad direction words may appear only as secondary context after named localities, not as the main area description.",
].join("\n");
